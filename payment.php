...
<div class="container">	
	<div class="text-left">	
		...
		<form class="form-horizontal" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="POST">
			...
			<input type='hidden' name='notify_url' value='http://jaynesjumpers.co.uk/shopping-cart-with-paypal-integration/notify.php'>
			<input type='hidden' name='return' value='http://jaynesjumpers.co.uk/shopping-cart-with-paypal-integration/success.php'>
